...
class Player():
    def __init__(self, name, playercolor, coloredname, money=2500, locations=[Pocetak], position=0, dice1=0,dice2=0,loste=0,wone=0,j=0):
        self.property=[]
        self.name = name
    ...
    def bonus(self):
        if self.locations[-1][4]=="J":
            ...
            if tr=="No":
                ...
                while tt!="No":
                    for x in Igraci:
                      if x.money >= 0:
                        text()
                        print("How much does ", x.coloredname, " offers this round? Please enter the number.")
                        k=int(input())
                        if k >m4:
                            won=x
                    text()
                    ...
                    tt=input()
                text()
                print("The winner of this auction is ", won.coloredname, "he/she bought ", self.locations[-1][7], "for ", self.locations[-1][5], "RSD .")
                won.property.append(self.locations[-1][7])
                won.money-=self.locations[-1][5]
                text()
            ...
            self.lost()
            for x in Igraci:
                if self.locations[-1][4]==x.owner:
                    x.wone=self.locations[-1][6]
                    x.won()
                    text()
        ...
        if self.dice1 == self.dice2:
            ...
            if self.j == 1:
                ...
                if self.money > 0 and self.j != 1:
                    ...
                    if self.dice1 == self.dice2:
                        text()
                        print(self.coloredname, " rolled doubles for the third time, he/she goes to jail.")
                        self.j = 1
                        self.position = 10
                        self.place()
                        self.clear()
...
text()
print("Please enter the name of fourth player.")
a4 = input()
